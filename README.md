...
[ツール一覧ページ](https://maruyamamasaya.github.io/tool/)から選ぶと、PCではツールがミニウィンドウで直接開きます。スマートフォンやタブレットでは通常表示で開きます。

| ツール | できること |
| --- | --- |
| [Image Resizer](https://maruyamamasaya.github.io/tool/image-resizer/) | JPG・PNG・WebP画像をブラウザ内でリサイズし、形式と品質を選んで保存できます。 |
...
| [chmod Calculator](https://maruyamamasaya.github.io/tool/chmod-calculator/) | chmodの数値・記号表記を日本語で確認し、チェック操作からファイル権限を生成できます。 |
...
| [Number Base Converter](https://maruyamamasaya.github.io/tool/number-base-converter/) | 2進数・10進数・12進数・16進数・24進数・60進数と2〜60の任意進数をリアルタイムで相互変換できます。 |
...
| [CSV エディター](https://maruyamamasaya.github.io/tool/csv-editor/) | CSVテキストを貼り付けて表形式で編集し、CSVまたはTXTファイルとして保存できます。 |
| [Table Builder](https://maruyamamasaya.github.io/tool/table-builder/) | GUIで表を編集し、Markdown・HTML・CSV形式でコピーまたは保存できます。 |
...
| [Audio Check](https://maruyamamasaya.github.io/tool/audio-check/) | 会議前にイヤフォンやスピーカーの左・右・ステレオ再生と、ブラウザから取得できる出力先情報を確認できます。 |
| [Microphone Check](https://maruyamamasaya.github.io/tool/microphone-check/) | マイクの入力レベルをリアルタイム表示し、10秒まで録音した声をブラウザ内で再生確認できます。 |
