...
const { parseDelimited, detectAndParse, formatRows, setCellValue } = require("./app.js");
...
const editableRows = [["1001"], ["1002", "佐藤花子"]];
assert.equal(setCellValue(editableRows, 0, 1, "山田太郎"), true);
assert.deepEqual(editableRows, [["1001", "山田太郎"], ["1002", "佐藤花子"]]);
assert.equal(setCellValue(editableRows, 3, 0, "範囲外"), false);
