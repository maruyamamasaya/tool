...
const { timestampToDate, datetimeToTimestamp, formatDate, formatDatetimeInput } = require('./app.js');
...
assert.strictEqual(formatDatetimeInput(new Date('2024-01-02T03:04:05Z'), 'utc'), '2024-01-02 03:04:05');
